...
class VinylStreamFromGlobObservable extends Observable_1.Observable {
    ...
    static create(glob, options, scheduler) {
        return new VinylStreamFromGlobObservable(glob, options, scheduler);
    }
...
exports.VinylStreamFromGlobObservable = VinylStreamFromGlobObservable;
